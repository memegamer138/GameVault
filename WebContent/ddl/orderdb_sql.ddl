...
INSERT INTO category(categoryName) VALUES ('PlayStation');
INSERT INTO category(categoryName) VALUES ('Xbox');
INSERT INTO category(categoryName) VALUES ('PC');
INSERT INTO category(categoryName) VALUES ('Nintendo Switch');
INSERT INTO category(categoryName) VALUES ('Accessories');


INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Last of Us', 1, 'RPG/Action/Sci-Fi by Naughty Dog',28.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Uncharted Bundle',1,'RPG/Action by Naughty Dog',69.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('GTA 6',3,'Crime/PG by Rockstar Games',30.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Spider-Man Miles Morales',1,'Action/Superhero by Insomniac',22.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Mario Bros Kart',4,'Racing by Nintendo',21.35);
INSERT product(productName, categoryId, productDesc, productPrice, productImageUrl) VALUES ('PS5 Controller',1,'Controller',25.00,'img\6.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Five Nights at Freddys',3,'Horror/Indie by Scott Cawthon',30.00, 'img\7.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Freddy Plushie',5,'Plushie',40.00,'img\8.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Valorant',3,'FPS/Shooting by Riot Games', 7.00,'img\9.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Ghost of Tsushima',1,'RPG/Fighting by Sucker Punch Productions',31.00,'img\10.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Dead by Daylight',3,'Horror/Online by Behaviour Interactive',21.00,'img\11.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Forza Horizon 4',2,'Racing by Microsoft',38.00,'img\12.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Midtown Madness',4,'Racing by Angel Studios',23.25,'img\13.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Shadow of the Colossus',1,'Action/Adventure by Japan Studio',15.50,'img\14.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Mario Smash Bros',4,'Fighting by Nintendo',17.45,'img\15.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Subnautica',1,'Survival/Adventure by Unknown Worlds Entertainment',19.00,'img\16.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Halo',2,'Online/Shooter by Microsoft',62.50,'img\17.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Need For Speed Poster',5,'Poster',9.20,'img\18.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Captain Claw',3,'Platform by Monolith Productions',81.00,'img\19.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Monopoly for Nintendo',4,'Family by Nintendo',10.00,'img\20.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Switch Controller (Blue)',5,'Controller',21.00,'img\21.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Vegeta Action Figure',5,'Dragon Ball Action Figure',14.00,'img\22.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Luigis Mansion',4,'Horror/Family by Nintendo',18.00,'img\23.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('RGB Keyboard',3,'Keyboard',99.00,'img\24.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Final Fantasy X1V',3,'Online/RPG by Square Enix',18.40,'img\25.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Donkey Kong',4,'Platform by Nintendo',89.65,'img\26.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Blair Witch',3,'Horror/RPG by Bloober Team',14.00,'img\27.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Xbox Controller (Camo)',5,'Controller',21.05,'img\28.jpg');
INSERT product(productName, categoryId, productDesc, productPrice, productImageURL) VALUES ('Apex Legends',1,'FPS/Online by Respawn Entertainment',14.00,'img\29.jpg');
...
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, tax, postalCode, country, userid, password) VALUES ('Arnold', 'Anderson', 'a.anderson@gmail.com', '204-111-2222', '103 AnyWhere Street', 'Winnipeg', 'MB', 0.05,'R3X 45T', 'Canada', 'arnold' , 'test');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, tax, postalCode, country, userid, password) VALUES ('Bobby', 'Brown', 'bobby.brown@hotmail.ca', '572-342-8911', '222 Bush Avenue', 'Boston', 'MA', 0.01,'22222', 'United States', 'bobby' , 'bobby');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, tax, postalCode, country, userid, password) VALUES ('Candace', 'Cole', 'cole@charity.org', '333-444-5555', '333 Central Crescent', 'Chicago', 'IL', 0.02, '33333', 'United States', 'candace' , 'password');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, tax, postalCode, country, userid, password) VALUES ('Darren', 'Doe', 'oe@doe.com', '250-807-2222', '444 Dover Lane', 'Kelowna', 'BC', 0.1, 'V1V 2X9', 'Canada', 'darren' , 'pw');
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, tax, postalCode, country, userid, password) VALUES ('Elizabeth', 'Elliott', 'engel@uiowa.edu', '555-666-7777', '555 Everwood Street', 'Iowa City', 'IA', 0.15, '52241', 'United States', 'beth' , 'test');
